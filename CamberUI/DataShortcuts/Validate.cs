...
namespace Camber.UI
{
    [NodeName("Validate Data Shortcuts")]
    [NodeDescription("Validates all Data Shortcuts.")]
    ...
    public class Validate : NodeModel
    {
        #region constructors
        /// <summary>
        /// Default constructor
        ...
        [JsonConstructor]
        private Validate(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(inPorts, outPorts) { }
        #endregion
        ...
        public override IEnumerable<AssociativeNode> BuildOutputAst(List<AssociativeNode> inputAsNodes)
        {
            ...
            var functionNode =
                AstFactory.BuildFunctionCall(
                    new Func<bool, bool>(DataShortcuts.Validate),
