...
namespace Camber.Civil.Styles.Graphs
{
    public sealed class ProfileViewStyle : Style
    {
        ...
        /// <summary>
        /// Gets the Graph Style of a Profile View, which specifies all graph-related properties.
        /// </summary>
        public GraphStyle GraphStyle => new GraphStyle(this, AeccProfileViewStyle.GraphStyle);
