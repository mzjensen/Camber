...
namespace Camber.Civil.Styles.Graphs
{
    public sealed class SectionViewStyle : Style
    {
        ...
        /// <summary>
        /// Gets the Graph Style of a Section View, which specifies all graph-related properties.
        /// </summary>
        public GraphStyle GraphStyle => new GraphStyle(this, AeccSectionViewStyle.GraphStyle);
