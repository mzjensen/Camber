...
namespace Camber.Civil.Styles.Views
{
    public sealed class MassHaulViewStyle : Style
    {
        ...
        /// <summary>
        /// Gets the View Style of a Mass Haul View, which specifies all view-related properties.
        /// </summary>
        public ViewStyle ViewStyle => new ViewStyle(this, AeccMassHaulViewStyle.GraphStyle);
