...
namespace Camber.UI
{
    [NodeName("Pipe Style Profile Properties")]
    [NodeCategory("Camber.Civil 3D.Styles.Object Styles.PipeStyle")]
    [NodeDescription("Select Pipe Style profile property name.")]
    [IsDesignScriptCompatible]
    public class PipeStyleProfileOptionsDropDown : DSDropDownBase
    {
        public PipeStyleProfileOptionsDropDown() : base("propertyName") { }

        [JsonConstructor]
        public PipeStyleProfileOptionsDropDown(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base("propertyName", inPorts, outPorts) { }
        ...
        protected override SelectionState PopulateItemsCore(string currentSelection)
        {
            ...
            var newItems = new List<DynamoDropDownItem>()
            {
                ...
                new DynamoDropDownItem("Crossing Hatch", "CrossingHatch"),
