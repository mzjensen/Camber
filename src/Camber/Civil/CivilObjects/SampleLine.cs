...
namespace Camber.Civil.CivilObjects
{
    ...
    public sealed class SampleLine : CivilObject
    {
        ...
        {
            LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MESSAGE, "SampleLine.ByStationSwathWidths"));
        ...
        public bool LockToStation
        {
            get
            {
                LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.IsLockedToStation"));
                return GetBool();
            }
        }
        ...
        public int Number
        {
            get
            {
                LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.Number"));
                return GetInt();
            }
        }
        ...
        public SampleLineGroup SampleLineGroup
        {
            get
            {
                LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.SampleLineGroup"));
        ...
        public IList<SectionView> SectionViews
        {
            get
            {
                LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.SectionViews"));
        ...
        {
            LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.SetLockedToStation"));
            SetValue(@bool);
            return this;
        }
        ...
        {
            LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.SetStation"));
            SetValue(station);
            return this;
        }
        ...
        public double Station
        {
            get
            {
                LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "SampleLine.Station"));
                return GetDouble();
            }
        }
