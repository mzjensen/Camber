...
namespace Camber.Civil.PipeNetworks.Parts
{
    ...
    public abstract class Part : CivilObject
    {
        ...
        {
            LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.AddToProfileView"));
        ...
        {
            LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.ApplyRules"));
        ...
        public string Domain
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.Domain"));
                return GetString();
            }
        }
        ...
        public string Material
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.Material"));
                return GetString();
            }
        }
        ...
        public string PartDescription
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.PartDescription"));
                return GetString();
            }
        }
        ...
        public string PartSubType
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.PartSubType"));
                return GetString();
            }
        }
        ...
        public PipeNetwork PipeNetwork
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.PipeNetwork"));
        ...
        public IList<ProfileView> ProfileViewsDisplayedIn
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.ProfileViewsDisplayedIn"));
        ...
        public civDynNodes.Alignment ReferenceAlignment
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.ReferenceAlignment"));
        ...
        public civDynNodes.Surface ReferenceSurface
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.ReferenceSurface"));
        ...
        {
            LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.RemoveFromProfileView"));
        ...
        public IList<SectionView> SectionsViewsDisplayedIn
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.SectionsViewsDisplayedIn"));
        ...
        {
            LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.SetReferenceAlignment"));
        ...
        {
            LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MIGRATION_MESSAGE, "Part.SetReferenceSurface"));
        ...
        public double WallThickness
        {
            get
            {
                LogWarningMessageEvents.OnLogWarningMessage(string.Format(Resources.NODE_DEPRECATED_MESSAGE, "Pipe.WallThickness or Structure.WallThickness"));
                return GetDouble();
            }
        }
