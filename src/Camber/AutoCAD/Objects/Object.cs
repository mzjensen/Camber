...
namespace Camber.AutoCAD.Objects
{
    public class Object : acDynNodes.Object
    {
        ...
        {
            LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MESSAGE, "Object.Color"));
        ...
        {
            LogWarningMessageEvents.OnLogInfoMessage(string.Format(Resources.NODE_OBSOLETE_MIGRATION_MESSAGE, "Object.SetColor"));
